...
public class PhotoPreviewFragment2 extends Fragment implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private class PhotoPagerAdapter extends PagerAdapter {
        ...
        public View instantiateItem(final ViewGroup container, final int position) {
            ...
            iv.setMaxZoom(5f);
            iv.setMinZoom(1f);
            view.findViewById(R.id.background).setTransitionName(photos.get(position).getPath()+"_background");
            iv.setTransitionName(photos.get(position).getPath());
