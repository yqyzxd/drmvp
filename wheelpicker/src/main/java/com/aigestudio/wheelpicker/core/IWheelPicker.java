...
public interface IWheelPicker {
     ...
     * So far, WheelPicker only support IWheelVo list for data set
     *
     * @param data 显示数据
     *             Display data set
     */
    void setData(List<IWheelVo> data);
     ...
     */
    void setData(List<IWheelVo> data, int index);
...
//    void setSelectedData(IWheelVo selectedData);
